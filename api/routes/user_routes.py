...
async def login_user(request:Request,time_duration:int,background_tasks: BackgroundTasks):
    ...
    request.cookies.set("thread_id", thread_id,max_age=time_duration*60)
    return JSONResponse(content={"success": True, "message": "User logged in successfully", "data": thread_id})
